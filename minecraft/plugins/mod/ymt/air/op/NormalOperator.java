...
public class NormalOperator extends AbstractOperator {
	...
	protected void addMoveableBlockIds(Set<Integer> result) {
		...
		// 1.6.1 で追加されたブロック
		result.add(Block.field_111039_cA.blockID); // 色付きレンガ
		result.add(Block.field_111038_cB.blockID); // 麦わらブロック
		result.add(Block.field_111031_cC.blockID); // カーペット
		result.add(Block.field_111032_cD.blockID); // 焼き粘土
		result.add(Block.field_111034_cE.blockID); // 石炭ブロック
	}
