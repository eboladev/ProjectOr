...
static const char qt_meta_stringdata_mygpo__Settings[] = {
    "mygpo::Settings\0\0finished()\0parseError()\0"
    "error\0requestError(QNetworkReply::NetworkError)\0"
    "QVariant\0settings\0"
};
...
const QMetaObjectExtraData mygpo::Settings::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject mygpo::Settings::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_mygpo__Settings,
      qt_meta_data_mygpo__Settings, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &mygpo::Settings::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_mygpo__Settings))
...
int mygpo::Settings::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QVariant*>(_v) = settings(); break;
        }
        _id -= 1;
