...
static const char qt_meta_stringdata_mygpo__TagList[] = {
    "mygpo::TagList\0\0finished()\0parseError()\0"
...
void mygpo::TagList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        TagList *_t = static_cast<TagList *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData mygpo::TagList::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject mygpo::TagList::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_mygpo__TagList,
      qt_meta_data_mygpo__TagList, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &mygpo::TagList::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_mygpo__TagList))
        return static_cast<void*>(const_cast< TagList*>(this));
...
int mygpo::TagList::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QVariant*>(_v) = tags(); break;
        }
        _id -= 1;
