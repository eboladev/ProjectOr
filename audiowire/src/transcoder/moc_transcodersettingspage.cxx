...
static const char qt_meta_stringdata_TranscoderSettingsPage[] = {
    "TranscoderSettingsPage\0"
};
...
const QMetaObjectExtraData TranscoderSettingsPage::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject TranscoderSettingsPage::staticMetaObject = {
    { &SettingsPage::staticMetaObject, qt_meta_stringdata_TranscoderSettingsPage,
      qt_meta_data_TranscoderSettingsPage, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &TranscoderSettingsPage::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TranscoderSettingsPage))
        return static_cast<void*>(const_cast< TranscoderSettingsPage*>(this));
