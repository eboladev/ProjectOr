...
static const char qt_meta_stringdata_Application[] = {
    "Application\0\0message\0ErrorAdded(QString)\0"
    "SettingsChanged()\0page\0"
    "SettingsDialogRequested(SettingsDialog::Page)\0"
    "AddError(QString)\0ReloadSettings()\0"
...
void Application::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->SettingsDialogRequested((*reinterpret_cast< SettingsDialog::Page(*)>(_a[1]))); break;
        case 3: _t->AddError((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 4: _t->ReloadSettings(); break;
        case 5: _t->OpenSettingsDialogAtPage((*reinterpret_cast< SettingsDialog::Page(*)>(_a[1]))); break;
        default: ;
        }
    }
}
