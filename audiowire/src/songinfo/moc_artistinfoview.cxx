...
static const char qt_meta_stringdata_ArtistInfoView[] = {
    "ArtistInfoView\0\0id,result\0"
...
void ArtistInfoView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        ArtistInfoView *_t = static_cast<ArtistInfoView *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData ArtistInfoView::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ArtistInfoView::staticMetaObject = {
    { &SongInfoBase::staticMetaObject, qt_meta_stringdata_ArtistInfoView,
      qt_meta_data_ArtistInfoView, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ArtistInfoView::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ArtistInfoView))
        return static_cast<void*>(const_cast< ArtistInfoView*>(this));
