...
static const char qt_meta_stringdata_GroupByDialog[] = {
    "GroupByDialog\0\0g\0Accepted(LibraryModel::Grouping)\0"
    "LibraryGroupingChanged(LibraryModel::Grouping)\0"
    "accept()\0Reset()\0"
};
...
void GroupByDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        GroupByDialog *_t = static_cast<GroupByDialog *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData GroupByDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject GroupByDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_GroupByDialog,
      qt_meta_data_GroupByDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &GroupByDialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GroupByDialog))
        return static_cast<void*>(const_cast< GroupByDialog*>(this));
