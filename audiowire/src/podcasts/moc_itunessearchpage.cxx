...
static const char qt_meta_stringdata_ITunesSearchPage[] = {
    "ITunesSearchPage\0\0SearchClicked()\0"
    "reply\0SearchFinished(QNetworkReply*)\0"
};
...
void ITunesSearchPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        ITunesSearchPage *_t = static_cast<ITunesSearchPage *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData ITunesSearchPage::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ITunesSearchPage::staticMetaObject = {
    { &AddPodcastPage::staticMetaObject, qt_meta_stringdata_ITunesSearchPage,
      qt_meta_data_ITunesSearchPage, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ITunesSearchPage::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ITunesSearchPage))
        return static_cast<void*>(const_cast< ITunesSearchPage*>(this));
