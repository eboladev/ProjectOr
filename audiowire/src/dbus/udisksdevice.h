 ...
 * Command line was: qdbusxml2cpp -N -m -p dbus/udisksdevice /home/mystte/rendu/audiowire-dev/src/dbus/org.freedesktop.UDisks.Device.xml
 *
...
#ifndef UDISKSDEVICE_H_1366756079
#define UDISKSDEVICE_H_1366756079
 ...
 */
class OrgFreedesktopUDisksDeviceInterface: public QDBusAbstractInterface
{
    Q_OBJECT
public:
...
public:
    OrgFreedesktopUDisksDeviceInterface(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);

    ~OrgFreedesktopUDisksDeviceInterface();
...
public Q_SLOTS: // METHODS
    ...
    inline QDBusPendingReply<QVariantList, QVariantList, QVariantList> DriveBenchmark(bool do_write_benchmark, const QStringList &options)
    {
        QList<QVariant> argumentList;
        argumentList << QVariant::fromValue(do_write_benchmark) << QVariant::fromValue(options);
        return asyncCallWithArgumentList(QLatin1String("DriveBenchmark"), argumentList);
    }
    inline QDBusReply<QVariantList> DriveBenchmark(bool do_write_benchmark, const QStringList &options, QVariantList &write_transfer_rate_results, QVariantList &access_time_results)
    {
        QList<QVariant> argumentList;
        argumentList << QVariant::fromValue(do_write_benchmark) << QVariant::fromValue(options);
        QDBusMessage reply = callWithArgumentList(QDBus::Block, QLatin1String("DriveBenchmark"), argumentList);
        if (reply.type() == QDBusMessage::ReplyMessage && reply.arguments().count() == 3) {
            write_transfer_rate_results = qdbus_cast<QVariantList>(reply.arguments().at(1));
            access_time_results = qdbus_cast<QVariantList>(reply.arguments().at(2));
        }
        return reply;
    }
    ...
    inline QDBusPendingReply<QVariantList> FilesystemListOpenFiles()
    {
        QList<QVariant> argumentList;
