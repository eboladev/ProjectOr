...
static const char qt_meta_stringdata_BusyIndicator[] = {
    "BusyIndicator\0QString\0text\0"
};
...
const QMetaObjectExtraData BusyIndicator::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject BusyIndicator::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_BusyIndicator,
      qt_meta_data_BusyIndicator, &staticMetaObjectExtraData }
};
...
int BusyIndicator::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_id < 0)
     ...
     if (_c == QMetaObject::ReadProperty) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: set_text(*reinterpret_cast< QString*>(_v)); break;
        }
        _id -= 1;
