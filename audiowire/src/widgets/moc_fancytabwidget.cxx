...
static const char qt_meta_stringdata_Core__Internal__FancyTabWidget[] = {
    ...
    "CurrentChanged(int)\0mode\0"
    "ModeChanged(FancyTabWidget::Mode)\0"
    "SetCurrentIndex(int)\0widget\0"
    "SetCurrentWidget(QWidget*)\0SetMode(Mode)\0"
    "SetMode(int)\0ShowWidget(int)\0"
};
...
void Core::Internal::FancyTabWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->CurrentChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->ModeChanged((*reinterpret_cast< FancyTabWidget::Mode(*)>(_a[1]))); break;
