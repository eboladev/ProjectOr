...
public:
    ...
    void setupUi(QWidget *TranscoderOptionsFlac)
    {
        ...
        label = new QLabel(TranscoderOptionsFlac);
    ...
    {
        TranscoderOptionsFlac->setWindowTitle(QApplication::translate("TranscoderOptionsFlac", "Form", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("TranscoderOptionsFlac", "Quality", 0, QApplication::UnicodeUTF8));
        label_2->setText(QApplication::translate("TranscoderOptionsFlac", "Fast", 0, QApplication::UnicodeUTF8));
        label_3->setText(QApplication::translate("TranscoderOptionsFlac", "Best", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
