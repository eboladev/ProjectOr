...
"}"));
    ...
    {
        label1->setText(QApplication::translate("DynamicPlaylistControls", "Dynamic mode is on", 0, QApplication::UnicodeUTF8));
        label2->setText(QApplication::translate("DynamicPlaylistControls", "New tracks will be added automatically.", 0, QApplication::UnicodeUTF8));
        expand->setText(QApplication::translate("DynamicPlaylistControls", "Expand", 0, QApplication::UnicodeUTF8));
        repopulate->setText(QApplication::translate("DynamicPlaylistControls", "Repopulate", 0, QApplication::UnicodeUTF8));
        off->setText(QApplication::translate("DynamicPlaylistControls", "Turn off", 0, QApplication::UnicodeUTF8));
        Q_UNUSED(DynamicPlaylistControls);
    } // retranslateUi
